  ...
  Wraps: [
    {
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, fresh vegetables, lettuce, tomato, and special sauce.",
    },
    {
      id: 2,
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, butter garlic mushrooms, vegetables, and herbs.",
    },
    {
      id: 3,
      name: "Crispy Paneer",
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, crispy paneer, vegetables, and tangy sauce.",
    },
    {
      id: 4,
      name: "Cheesy Paneer",
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, cheesy paneer, vegetables, and creamy sauce.",
    },
    {
      id: 5,
      name: "Crispy Chicken",
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, crispy fried chicken, vegetables, and mayo.",
    },
    {
      id: 6,
      name: "Chilli Chicken",
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, spicy chilli chicken, vegetables, and hot sauce.",
    },
    {
      id: 7,
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, tandoori marinated chicken, vegetables, and mint sauce.",
    },
    {
      id: 8,
      ...
      vegetarian: false,
      vegan: false,
      ingredients: "Wheat tortilla, Mexican spiced chicken, cheese, and salsa.",
    },
    {
      id: 9,
      ...
      vegan: false,
      ingredients:
        "Wheat tortilla, grilled chicken, cheese, vegetables, and special sauce.",
    },
  ],
  Fries: [
    {
      ...
      vegetarian: true,
      vegan: true,
      ingredients: "Golden crispy potato fries, perfectly seasoned.",
    },
    {
      id: 11,
      ...
      vegetarian: true,
      vegan: true,
      ingredients: "Crispy fries tossed in spicy peri peri seasoning.",
    },
    {
      id: 12,
      name: "Signature Mixed Fries",
      vegetarian: true,
      vegan: true,
      ingredients: "A mix of crispy fries with special seasoning blend.",
    },
    {
      id: 13,
      ...
      vegetarian: false,
      vegan: false,
      ingredients: "Crispy golden chicken nuggets, perfectly fried.",
    },
    {
      id: 14,
      ...
      vegetarian: false,
      vegan: false,
      ingredients: "Tender chicken strips, breaded and fried to perfection.",
    },
    {
      id: 15,
      name: "Chicken-Loaded Crispy Fries",
      vegetarian: false,
      vegan: false,
      ingredients: "Crispy fries loaded with chicken, cheese, and sauces.",
    },
    {
      id: 16,
      ...
      vegetarian: true,
      vegan: false,
      ingredients: "Crispy fries loaded with melted cheese and sauces.",
    },
  ],
  UFO: [
    {
      ...
      vegetarian: true,
      vegan: false,
      ingredients: "Crispy vegetable filling in a soft wrap.",
    },
    {
      id: 18,
      ...
      vegetarian: true,
      vegan: false,
      ingredients: "Paneer or mushroom filling with vegetables and sauces.",
    },
    {
      id: 19,
      name: "Chicken",
      vegetarian: false,
      vegan: false,
      ingredients: "Tender chicken filling with vegetables and special sauce.",
    },
    {
      id: 20,
      name: "Zinger Chicken",
      vegetarian: false,
      vegan: false,
      ingredients: "Spicy zinger chicken with vegetables and mayo.",
    },
    {
      id: 21,
      name: "Cheese Burst",
      vegetarian: true,
      vegan: false,
      ingredients: "Melted cheese burst with vegetables and sauces.",
    },
  ],
  Thickshakes: [
    {
      id: 22,
      name: "Butterscotch Banana",
      vegetarian: true,
      vegan: false,
      ingredients:
        "Creamy butterscotch with fresh banana, blended to perfection.",
    },
    {
      id: 23,
      name: "Oreo",
      vegetarian: true,
      vegan: false,
      ingredients: "Crushed Oreo cookies blended with creamy milkshake.",
    },
    {
      id: 24,
      ...
      vegetarian: true,
      vegan: false,
      ingredients: "Rich coffee flavor with creamy milkshake base.",
    },
    {
      id: 25,
      name: "KitKat",
      vegetarian: true,
      vegan: false,
      ingredients: "Crushed KitKat chocolate blended with creamy milkshake.",
    },
    {
      id: 26,
      name: "Protein",
      vegetarian: true,
      vegan: false,
      ingredients: "High protein milkshake with your choice of flavor.",
    },
    {
      id: 27,
      ...
      vegetarian: true,
      vegan: false,
      ingredients: "Rich Belgian chocolate blended into creamy milkshake.",
    },
    {
      id: 28,
      name: "Nutella",
      vegetarian: true,
      vegan: false,
      ingredients: "Creamy Nutella hazelnut spread blended with milkshake.",
    },
  ],
  Mojitos: [
    {
      ...
      vegetarian: true,
      vegan: true,
      ingredients: "Refreshing blue mojito with mint and lemon.",
    },
    {
      id: 30,
      name: "Virgin",
      vegetarian: true,
      vegan: true,
      ingredients: "Classic virgin mojito with fresh mint and lime.",
    },
    {
      id: 31,
      name: "Mint",
      vegetarian: true,
      vegan: true,
      ingredients: "Fresh mint mojito with lemon and soda.",
    },
    {
      id: 32,
      ...
      vegetarian: true,
      vegan: true,
      ingredients: "Grilled pineapple mojito with mint and lime.",
    },
    {
      id: 33,
      name: "Watermelon",
      vegetarian: true,
      vegan: true,
      ingredients: "Fresh watermelon mojito with mint and lemon.",
    },
  ],
};
...
const getItemImage = (
  category: keyof typeof menuItems,
  itemName: string,
): string => {
...
export default function WrapVariants() {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<keyof typeof menuItems>("Wraps");
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center justify-center gap-6 md:gap-10 lg:gap-12">
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 md:w-14 md:h-14 flex items-center justify-center text-3xl md:text-4xl transition-transform ${
              ...
              return (
                <a
                  ...
                  className={`flex flex-col items-center gap-2 transition-all cursor-pointer group flex-shrink-0 ${
                    isActive ? "text-wrappy-red" : "text-gray-500"
                  }`}
                >
                  <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
          ...
          <div className="lg:col-span-3 order-2 lg:order-2">
            ...
            <ul
              ref={variantsRef}
              className="space-y-0 max-h-64 md:max-h-none overflow-y-auto md:overflow-visible"
            >
